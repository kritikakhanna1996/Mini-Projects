...
(103,'USR003','Megaduta Dheer',9325049602,'dheerm@gmail.com',NULL),(104,'USR004','Chatur Mahalanabis',7135247807,'mahalanabisc@yahoo.co.in',NULL),
(105,'USR005','Shackcham Bajpeyi',7836088705,'bajpeyis@yahoo.com',NULL),(106,'USR006','Vineet Hegadi',8824587622,'hegadiv@gmail.com',NULL),
(107,'USR007','Vakpati Munshi',6547277826,'munshiv@gmail.com',NULL),(108,'USR008','Kusika Rajavade',8481700165,'rajavadek@yahoo.com',NULL),
(109,'USR009','Gagan Panda',7121254186,'pandag@edge.com',NULL),(110,'USR010','Mishri Nayar',9824959314,'nayarm@edge.com',NULL),
(111,'USR011','Amara Mudaliyar',9287282100,'mudaliyara@yahoo.com',NULL),(112,'USR012','Shinu Sanyal',6732250379,'sanyals@edge.com',NULL),
(113,'USR013','Vijaya Mayadev',8844350689,'mayadevv@edge.com',NULL),(114,'USR014','Durgautti Misra',8169330574,'misrad@edge.com',NULL),
(115,'USR015','Jayanti Chadda',9468271869,'chaddaj@edge.com',NULL),(116,'USR016','Ronald D\'Souza',6943983550,'kumarb@gmail.com',NULL),
(117,'USR017','Nagini Sarkar',7458743576,'sarkarn@yahoo.com',NULL),(118,'USR018','Akshara Pandey',6475579718,'pandeya@ipl.co.in',NULL),
(119,'USR019','Madri Valimbe',9807726348,'valimbem@gmail.com',NULL),(120,'USR020','Saurandhri Mahanta',8465838514,'mahantas@yahoo.co.in',NULL),
(121,'USR021','Aryabhatta Parachure',6887518099,'parachurea@yahoo.com',NULL),(122,'USR022','Veer Tipanis',6709912746,'tipanisv@ipl.co.in',NULL),
(123,'USR023','Ganesh Phadatare',6722490653,'phadatareg@ipl.co.in',NULL),(124,'USR024','Sackhcham Nayar',7563150546,'nayars@edge.com',NULL),
(125,'USR025','Gagan Adwani',6665727109,'adwanig@yahoo.com',NULL),(126,'USR026','Vincy Fernandes',6815856957,'vinfern@yahoo.co.in',NULL),
(127,'USR027','Panini Mallaya',7415107521,'mallayap@yahoo.co.in',NULL),(128,'USR028','Salil Choudhary',9187146065,'salilch@yahoo.co.in',NULL),
(129,'USR029','Aryabhata Valimbe',8580175938,'valimbea@ipl.co.in',NULL),(130,'USR030','Nawazuddin Saif',9017365395,'nawazs@gmail.com',NULL),
...
INSERT INTO IPL_BIDDER_POINTS VALUES (102,2018,4,4,0,NULL),(103,2018,5,5,19,'Runner up'),(104,2018,7,5,17,NULL),(105,2018,9,8,4,NULL),
(106,2018,10,9,14,NULL),(107,2018,8,7,6,NULL),(108,2018,7,6,6,NULL),(109,2018,5,4,0,NULL),(110,2018,9,8,15,NULL),(111,2018,7,6,7,NULL),
(112,2018,8,8,9,NULL),(113,2018,7,7,9,NULL),(114,2018,8,7,10,NULL),(115,2018,6,6,5,NULL),(116,2018,3,3,0,NULL),(117,2018,5,3,5,NULL),
(118,2018,6,6,15,NULL),(119,2018,10,8,2,NULL),(120,2018,4,4,5,NULL),(121,2018,11,11,35,'Winner'),(122,2018,3,3,4,NULL),(123,2018,6,6,11,NULL),
(124,2018,5,5,7,NULL),(125,2018,9,7,8,NULL),(126,2018,5,5,12,NULL),(127,2018,8,8,12,NULL),(128,2018,4,4,4,NULL),(129,2018,8,8,9,NULL),
(130,2018,7,7,5,NULL),(131,2018,6,6,12,NULL);
...
select bidder_id,count(bid_status) as total_matches,sum(if(bid_status='Won',1,0)) as matches_won, 
round((sum(if(bid_status='Won',1,0))/count(bid_status))*100,2) as Percentage_of_wins
...
select s.stadium_name,s.city,count(ms.match_id) as Number_of_matches
from ipl_stadium s left join ipl_match_schedule ms on s.stadium_id=ms.stadium_id
...
select s.stadium_id,s.stadium_name,s.city,count(m.match_id) as number_of_matches,sum(if(m.toss_winner=m.match_winner,1,0)) as wins_by_toss_winners
,round(sum(if(m.toss_winner=m.match_winner,1,0))/count(m.match_id),2)*100 as percentage_wins_by_toss_winners
from ipl_stadium s left join ipl_match_schedule ms on s.stadium_id=ms.stadium_id
...
select t.team_id,t.team_name,count(no_of_bids) as total_bids
...
select if(match_winner=1,team_id1,team_id2) as Team_Id,win_details 
from ipl_match ;
...
select t.team_id,t.team_name,sum(ts.matches_played) as total_matches_played ,sum(ts.matches_won) as total_matches_won ,sum(ts.matches_lost) as total_matches_lost
...
select t.team_id,t.team_name,count(tp.player_role) as number_of_all_rounders
from ipl_team t join ipl_team_players tp on t.team_id=tp.team_id
